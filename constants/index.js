...
export const HowWeWork = [
    {
        title: "View causes",
        content: "View a wide range of causes that foster socio-economic growth and more.",
        src: "/card1.svg",
        variant: "outline",
    },
    {
        title: "Make donations",
        content: "Make donations to causes that you sympathize with.",
        src: "/card2.svg",
        variant: "outline",
    },
    {
        title: "View how your donations are used?",
        content: "Using the power of blockchain, you can monitor all donations made on our platform.",
        src: "/card3.png",
        variant: "outline",
    },
...
export const Causes = [
    {
        ...
        content1: "Empowering Artisans: We provide vocational training to individuals, helping them acquire valuable skills to become proficient artisans.",
        content2: "Economic Contribution: By gaining these skills, individuals can join the labor force, contributing to the nation's GDP and overall economic growth.",
    },
    {
        title: "Support for GBV Victims",
        content1: "Holistic Recovery: We offer comprehensive support to victims of gender-based violence, aiding in both their emotional and physical healing.",
        content2: "Safe Spaces: Our initiatives include creating safe spaces and providing necessary resources to help victims rebuild their lives.",
    },
    {
        title: "Education",
        content1: "Access to Education: We strive to send children of various ages to school, ensuring they have access to quality education.",
        content2: "Future Leaders: By investing in their education, we aim to improve their lives and contribute to the country's future development.",
    },
    {
        title: "Basic Necessities",
        content1: "Essential Aid: We provide food, healthcare, shelter, and clothing to those in need, ensuring they have access to basic life necessities.",
        content2: "Health and Well-being: Our support extends to ensuring individuals have access to healthcare services, promoting their overall well-being.",
    },
]
...
export const WhoIs = [
    {
        key: 1,
        list: "Empowering the Less Privileged: Refreegerians support initiatives that provide vocational training, aid to GBV victims, education, and basic necessities."
    },
    {
        key: 2,
        list: "Ensuring Transparency: They trust and utilize our blockchain-based platform to track donations and see real-time impacts."
    },
    {
        key: 3,
...
export const faq = [
    ...
    {
        key: 4,
        question: "Who can join RefreeG?",
        answer: ""
    },
    {
        key: 5,
        question: "Is RefreeG a startup?",
        answer: ""
    },
    {
        key: 6,
