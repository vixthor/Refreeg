        ...
        {petitions.map(({ id, title, description, endDate, image, link }) => (
          ...
          >
            ...
            <Link href="/ramadandrive/whatareyoudonating">
              <button className="flex gap-2 items-center justify-center bg-blue-500 text-white p-2 rounded-b-2xl w-full hover:bg-blue-700 transition-all duration-300 ease-in-out glowing-button font-bold">
                Donate
                <Image
