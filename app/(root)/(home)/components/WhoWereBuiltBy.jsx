    ...
    <section className="w-full h-full px-[10px] md:px-[50px] py-[25px] my-[200px]">
      <div>
        ...
        <p className="text-[16px] text-center mt-[20px] mb-[40px]">
          RefreeG was founded by a passionate and diverse team committed to
          making a significant impact in African{" "}
          <br className="hidden md:block" /> communities through empowerment and
