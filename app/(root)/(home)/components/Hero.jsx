  ...
  return (
    ...
    >
      ...
      <div className="md:pt-10 mt-12 md:mt-0 text-center">
        ...
        <p className="text-[65px] md:text-[100px] font-bold md:font-semibold text-accent">
          RefreeG
        </p>
        ...
        <Link
          ...
          className="flex gap-[6px] bg-light py-[10px] px-[15px] rounded-[8px] text-bold text-[15px] items-center justify-center mx-auto relative z-30 
              md:mt-16 mt-8 font-semibold cursor-pointer hover:bg-accent hover:text-light transition"
        >
          Join our Community
          <ArrowRight size={"18"} />
        </Link>
