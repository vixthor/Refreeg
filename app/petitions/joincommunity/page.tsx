    ...
    <div className="flex flex-col px-6 sm:px-12 gap-4 sm:gap-6">
      ...
      <div className="flex flex-col sm:flex-row justify-center sm:justify-end gap-4 sm:gap-6">
        <Link href={`/petitions/petition?title=${encodeURIComponent(title)}`}>
          <button className="w-full sm:w-[300px] px-4 py-2 bg-[#b5b3b3] rounded-md text-neutral-50 text-base font-mediumw font-montserrat hover:bg-[#737272] transition-colors">
            Skip
          </button>
        </Link>

        <Link href="http://t.me/+d67UCIer8c01ODhk">
          <button className="w-full sm:w-[300px] flex items-center justify-center gap-2 px-4 py-2 bg-blue-600 rounded-md text-neutral-50 text-base font-medium font-montserrat hover:bg-[#214b7b] transition-colors">
            Join Community
            <Image
